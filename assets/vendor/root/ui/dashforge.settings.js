...
$(function(){
    'use strict'
    // $.ajax({
    //   url: '/vendor/root/ui//settings.html',
    ...
    //     if(hasMode) {
    //       $('head').append('<link id="dfMode" rel="stylesheet" href="/vendor/root/ui/assets/css/skin.'+hasMode+'.css">')
    ...
    //     if(hasSkin) {
    //       $('head').append('<link id="dfSkin" rel="stylesheet" href="/vendor/root/ui/assets/css/skin.'+hasSkin+'.css">')
    ...
    $('body').on('click', '.df-mode', function(e){
      ...
      if(!$(this).hasClass('disabled')) {
        ...
        if(mode === 'classic') {
          ...
          if($('#dfMode').length === 0) {
            if($('#dfSkin').length === 0) {
              $('head').append('<link id="dfMode" rel="stylesheet" href="/vendor/root/ui/assets/css/skin.'+mode+'.css">');
            } else {
              $('<link id="dfMode" rel="stylesheet" href="/vendor/root/ui/assets/css/skin.'+mode+'.css">').insertBefore($('#dfSkin'));
            }
          } else {
            $('#dfMode').attr('href', '/vendor/root/ui/assets/css/skin.'+mode+'.css');
          }
    ...
    $('body').on('click', '.df-skin', function(e){
      ...
      if(skin === 'default') {
        ...
        if($('#dfSkin').length === 0) {
          $('head').append('<link id="dfSkin" rel="stylesheet" href="/vendor/root/ui/assets/css/skin.'+skin+'.css">')
        } else {
          $('#dfSkin').attr('href', '/vendor/root/ui/assets/css/skin.'+skin+'.css');
        }
